...
public class TicTacTou implements ActionListener {
    ...
    public TicTacTou(){
        ...
        title_panel.setLayout(new BorderLayout());  //raširi pozadinu po celom naslovu
                ...
                if (reset) {
                    ...
                    try {
                       ...
                       // System.out.println("radi");
                        frame.dispose();
                       TicTacTou tictactoe = new TicTacTou();
                    } catch (InterruptedException e) {
                        e.printStackTrace();
                    }
                }
